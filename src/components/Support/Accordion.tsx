    ...
    <AccordionPrimitive.Root type="single" collapsible>
      {items.map((item, index) => (
        <AccordionPrimitive.Item
          key={index}
          value={item.title}
          className="rounded-lg mb-2 bg-white-4 px-3 py-4 border-none overflow-hidden focus-within:relative last:mb-0 "
        >
          ...
          <AccordionPrimitive.Content className="text-baseGray font-normal text-sm/[21px] overflow-hidden data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown">
